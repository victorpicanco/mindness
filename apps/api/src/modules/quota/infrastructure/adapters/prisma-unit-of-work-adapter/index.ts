...
import type { QuotaPrismaTransactionRunner } from '@/modules/quota/infrastructure/clients/quota-prisma-client/index.js'
...
function isWriteConflict(error: unknown): boolean {
  if (error instanceof QuotaCycleAlreadyOpenError) return true
...
export class PrismaUnitOfWorkAdapter implements UnitOfWork {
  ...
  constructor(
    private readonly prisma: QuotaPrismaTransactionRunner,
