...
import type { RequestAudioUploadUrlUseCase } from '@/modules/sessions/application/use-cases/request-audio-upload-url/index.js'
...
export class RequestAudioUploadUrlController {
  constructor(private readonly useCase: RequestAudioUploadUrlUseCase) {}
