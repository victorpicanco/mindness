...
import { PublishThemeUseCase } from './index.js'

function draftTheme(): Theme {
  return Theme.create({
    id: 'theme-1',
...
describe('PublishThemeUseCase', () => {
  it('publishes a draft theme and audits the pool after persisting it', async () => {
    const harness = createHarness(draftTheme())
