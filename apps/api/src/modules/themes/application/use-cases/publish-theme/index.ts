...
import type { PublishThemeInput, PublishThemeOutput } from './types.js'

export interface PublishThemeDependencies {
  readonly themes: ThemesRepository
  readonly themePoolAudit: ThemePoolAudit
}

export class PublishThemeUseCase {
  constructor(private readonly dependencies: PublishThemeDependencies) {}

  async execute(input: PublishThemeInput): Promise<PublishThemeOutput> {
...
export type { PublishThemeInput, PublishThemeOutput } from './types.js'
