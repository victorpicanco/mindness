...
describe('ShowcasePage', () => {
  ...
  it('shows the temporary component showcase', () => {
    ...
    expect(screen.getByRole('button', { name: 'Informativo' })).toBeInTheDocument()
    expect(screen.getByRole('button', { name: 'Sucesso' })).toBeInTheDocument()
    expect(screen.getByRole('button', { name: 'Aviso' })).toBeInTheDocument()
